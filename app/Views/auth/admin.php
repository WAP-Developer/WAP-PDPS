		...
		<div class="form-form-wrap">
			<div class="form-container">
				<div class="form-content">
					...
					<form id="fromAdmin" class="text-left" action="javascript:void(0);" novalidate>
						<div class="form">
							...
							<div id="username-field" class="field-wrapper input">
								...
								<input id="formUsername" name="username" type="text" class="form-control" placeholder="Username">
							...
							<div class="d-sm-flex justify-content-between">
								...
								<div class="field-wrapper">
									<button type="submit" onclick="loginAdmin()" class="btn btn-primary">Masuk</button>
								</div>
