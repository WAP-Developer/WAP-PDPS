        ...
        <tr>
            <td>
                ...
                <div style="width:884px;">
                    <div class="jenis-surat">SURAT KETERANGAN DOMISILI WARGA</div>
                    ...
                    <div class="isi">
                        ...
                        <div class="pembukaan" style="margin-top: 10px;">Berdasarkan keterangan dari Ketua RT/RW
                            setempat, Nama tersebut Benar bertempat tinggal/Domisili pada alamat tersebut diatas, dan
                            Benar warga atau penduduk
                            kami, keterangan ini berlaku dari tanggal :</div>
                        <div class="data-pemohon" style="margin-top: 10px;">
                            <div class="tanggal-berlaku"> <?= tanggal_indonesia($detail['tanggal_surat']) ?> s/d <?= tanggal_indonesia($detail['masa_berlaku']) ?></div>
                        </div>
